...
def main(stem): #{
	...
	if stem['theme'] == '1' : #{
		...
		forms = quad_past(stem['root'], stem['vowel_perf']);
		forms.update(quad_pres(stem['root'], stem['vowel_perf']));
		forms.update(quad_imp(stem['root'], stem['vowel_perf']));
		if stem['pp'] != '' : #{
			forms.update(quad_pp(stem['root'], stem['vowel_perf'], stem['pp']));
	#}

	elif stem['theme'] == '2' : #{
		forms = quad_patt2_past(stem['root'], stem['vowel_perf']);
		forms.update(quad_patt2_pres(stem['root'], stem['vowel_perf']));
		forms.update(quad_patt2_imp(stem['root'], stem['vowel_perf']));
		if 'pp' != '' : #{
