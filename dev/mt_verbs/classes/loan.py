...
def loan_pres_first_vowel(stem, ixx, vowel_pres): #{
...
def loan_pres_first_cons(stem, ixx, vowel_pres): #{
...
#		ixx = stem['ixx'];   # ixx = 'ixx';
	...
	if stem['subtype'] == 'first_vowel': #{
		forms = loan_past(stem['base'], ixx, stem['vowel_impf']);
		forms.update(loan_pres_first_vowel(stem['base'], ixx, stem['vowel_impf']));
		forms.update(loan_imp(stem['base'], ixx, stem['vowel_impf']));
	#}

	elif stem['subtype'] == 'first_cons': #{
		forms = loan_past(stem['base'], ixx, stem['vowel_impf']);
		forms.update(loan_pres_first_cons(stem['base'], ixx, stem['vowel_impf']));
		forms.update(loan_imp(stem['base'], ixx, stem['vowel_impf']));
	#}

	elif stem['subtype'] == 'two_cons' : #{
		forms = loan_past(stem['base'], ixx, stem['vowel_impf']);
		forms.update(loan_pres_two_cons(stem['base'], ixx, stem['vowel_impf']));
		forms.update(loan_imp(stem['base'], ixx, stem['vowel_impf']));
	#}

	elif stem['subtype'] == 'double_cons' : #{
		forms = loan_past_double_cons(stem['base'], ixx, stem['vowel_impf']);
		forms.update(loan_pres_two_cons(stem['base'], ixx, stem['vowel_impf']));
		forms.update(loan_imp('i' + stem['base'], ixx, stem['vowel_impf']));
	#}
