...
def loan_past_forms(forms, stem, ixx, vowel_pres, r, tv): #{
	...
	if vowel_pres == 'i': #{
		...
		forms['past.p2.sg'] += loan_consonant_forms(stem + 'ejt', stem + 'ejt', r, tv);	
		forms['past.p1.sg'] += loan_consonant_forms(stem + 'ejt', stem + 'ejt', r, tv);
		forms['past.p3.pl'] += loan_vowel_forms(stem + 'ew', stem + 'ew', r, tv);
		forms['past.p2.pl'] += loan_vowel_forms(stem + 'ejtu', stem + 'ejtu', r, tv);
		forms['past.p1.pl'] += loan_vowel_forms(stem + 'ejna', stem + 'ejnie', r, tv);
	#}
	else : #{   vowel_pres == a
		forms['past.p3.m.sg'] += loan_vowel_forms(stem + ixx + 'a', stem + 'a', r, tv);
		forms['past.p3.f.sg'] += loan_consonant_forms(stem + 'at', stem + 'at', r, tv);
		forms['past.p2.sg'] += loan_consonant_forms(stem + 'ajt', stem + 'ajt', r, tv);	
		forms['past.p1.sg'] += loan_consonant_forms(stem + 'ajt', stem + 'ajt', r, tv);
		forms['past.p3.pl'] += loan_vowel_forms(stem + 'aw', stem + 'aw', r, tv);
		forms['past.p2.pl'] += loan_vowel_forms(stem + 'ajtu', stem + 'ajtu', r, tv);
		forms['past.p1.pl'] += loan_vowel_forms(stem + 'ajna', stem + 'ajnie', r, tv);
	#}
...
def loan_pres_first_vowel(stem, ixx, vowel_pres, tv): #{
	...
	# (+ jistabilixxa, but jistabilini)
		...
		forms['pres.p3.pl'] = loan_vowel_forms(stem + ixx + pl_suffix, stem + pl_suffix, 'LR', tv);
		forms['pres.p3.pl'] += loan_vowel_forms('j' + stem + ixx + pl_suffix, 'j' + stem + pl_suffix, 'LR', tv);
		forms['pres.p3.pl'] += loan_vowel_forms(stem + ixx + pl_suffix, stem + pl_suffix, 'RL', tv);
	#}
	else : #{
		forms['pres.p3.m.sg'] = loan_vowel_forms('j' + stem + ixx + sg_suffix, 'j' + stem + sg_suffix, '-', tv);
		forms['pres.p3.pl'] = loan_vowel_forms('j' + stem + ixx + pl_suffix, 'j' + stem + pl_suffix, '-', tv);
	#}

	forms['pres.p3.f.sg'] = loan_vowel_forms('t' + stem + ixx + sg_suffix, 't' + stem + sg_suffix, '-', tv);
	forms['pres.p2.sg'] = loan_vowel_forms('t' + stem + ixx + sg_suffix, 't' + stem + sg_suffix, '-', tv)
	forms['pres.p1.sg'] = loan_vowel_forms('n' + stem + ixx + sg_suffix, 'n' + stem + sg_suffix, '-', tv);

	forms['pres.p2.pl'] = loan_vowel_forms('t' + stem + ixx + pl_suffix, 't' + stem + pl_suffix, '-', tv);
	forms['pres.p1.pl'] = loan_vowel_forms('n' + stem + ixx  + pl_suffix, 'n' + stem + pl_suffix, '-', tv);
...
def loan_pres_first_cons(stem, ixx, vowel_pres, tv): #{
	...
	forms['pres.p2.sg'] = loan_vowel_forms('t' + stem + ixx + sg_suffix, 't' + stem + sg_suffix, 'LR', tv);
	forms['pres.p2.sg'] += loan_vowel_forms(first_cons + stem + ixx + sg_suffix, first_cons + stem + sg_suffix, 'LR', tv);
	forms['pres.p2.sg'] += loan_vowel_forms('it' + stem + ixx + sg_suffix, 'it' + stem + sg_suffix, 'LR', tv);
	forms['pres.p2.sg'] += loan_vowel_forms('i' + first_cons + stem + ixx + sg_suffix, 'i' + first_cons + stem + sg_suffix, 'LR', tv);
	forms['pres.p2.sg'] += loan_vowel_forms('it' + stem + ixx + sg_suffix, 'it' + stem + sg_suffix, 'RL', tv);

	forms['pres.p1.sg'] = loan_vowel_forms('n' + stem + ixx + sg_suffix, 'n' + stem + sg_suffix, 'LR', tv);
	forms['pres.p1.sg'] += loan_vowel_forms('in' + stem + ixx + sg_suffix, 'in' + stem + sg_suffix, 'LR', tv);
	forms['pres.p1.sg'] += loan_vowel_forms('in' + stem + ixx + sg_suffix, 'in' + stem + sg_suffix, 'RL', tv);

	forms['pres.p3.pl'] = loan_vowel_forms('i' + stem + ixx + pl_suffix, 'i' + stem + pl_suffix, 'LR', tv);
	forms['pres.p3.pl'] += loan_vowel_forms('j' + stem + ixx + pl_suffix, 'j' + stem + pl_suffix, 'LR', tv);
	forms['pres.p3.pl'] += loan_vowel_forms('i' + stem + ixx + pl_suffix, 'i' + stem + pl_suffix, 'RL', tv);

	forms['pres.p2.pl'] = loan_vowel_forms('t' + stem + ixx + pl_suffix, 't' + stem + pl_suffix, 'LR', tv);
	forms['pres.p2.pl'] += loan_vowel_forms(first_cons + stem + ixx + pl_suffix, first_cons + stem + pl_suffix, 'LR', tv);
	forms['pres.p2.pl'] += loan_vowel_forms('it' + stem + ixx + pl_suffix, 'it' + stem + pl_suffix, 'LR', tv);
	forms['pres.p2.pl'] += loan_vowel_forms('i' + first_cons + stem + ixx + pl_suffix, 'i' + first_cons + stem + pl_suffix, 'LR', tv);
	forms['pres.p2.pl'] += loan_vowel_forms('it' + stem + ixx + pl_suffix, 'it' + stem + pl_suffix, 'RL', tv);

	forms['pres.p1.pl'] = loan_vowel_forms('n' + stem + ixx  + pl_suffix, 'n' + stem + pl_suffix, 'LR', tv);
	forms['pres.p1.pl'] += loan_vowel_forms('in' + stem + ixx  + pl_suffix, 'in' + stem + pl_suffix, 'LR', tv);
	forms['pres.p1.pl'] += loan_vowel_forms('in' + stem + ixx  + pl_suffix, 'in' + stem + pl_suffix, 'RL', tv);
...
# two or double
	...
	forms['pres.p2.sg'] = loan_vowel_forms('ti' + stem + ixx + sg_suffix, 'ti' + stem + sg_suffix, '-', tv);
	forms['pres.p1.sg'] = loan_vowel_forms('ni' + stem + ixx + sg_suffix, 'ni' + stem + sg_suffix, '-', tv);

	forms['pres.p3.pl'] = loan_vowel_forms('ji' + stem + ixx + pl_suffix, 'ji' + stem + pl_suffix, '-', tv);
	forms['pres.p2.pl'] = loan_vowel_forms('ti' + stem + ixx + pl_suffix, 'ti' + stem + pl_suffix, '-', tv);
	forms['pres.p1.pl'] = loan_vowel_forms('ni' + stem + ixx  + pl_suffix, 'ni' + stem + pl_suffix, '-', tv);
...
#
	if vowel_pres == 'i': #{
		# jistabilixxa, but jistabilini
		forms['imp.p2.sg'] = loan_vowel_forms(stem + ixx + 'i', stem + 'i', '-', tv);
		forms['imp.p2.pl'] = loan_vowel_forms(stem + ixx + 'u', stem + 'u', '-', tv);
	#}
	else : #{   vowel_pres == a
		forms['imp.p2.sg'] = loan_vowel_forms(stem + ixx + 'a', stem + 'a', '-', tv);
		forms['imp.p2.pl'] = loan_vowel_forms(stem + ixx + 'aw', stem + 'aw', '-', tv);
	#}
